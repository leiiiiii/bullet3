...
def main():
    ...
    Endeffectorsliderx= environment._p.addUserDebugParameter("endeffector_x",-dtheta,dtheta,0)
    Endeffectorslidery = environment._p.addUserDebugParameter("endeffector_y", -dtheta, dtheta, 0)
    Endeffectorsliderz = environment._p.addUserDebugParameter("endeffector_z", -dtheta, dtheta, 0)
