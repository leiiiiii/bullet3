...
import mmNeobotixSchunkGymEnv


def main():
    environment = mmNeobotixSchunkGymEnv.MMNeobotixSchunkGymEnv(renders=True,isDiscrete=False, maxSteps=100000000)
    ...
    if (environment._useInversekinematics == 1):
        ...
        actionIds = [leftwheelVelocitySlider, rightwheelVelocitySlider, Endeffectorsliderx, Endeffectorslidery,
                     Endeffectorsliderz]
    else:
        leftwheelVelocitySlider = environment._p.addUserDebugParameter("basevelocity", -dv, dv, 0)
        rightwheelVelocitySlider = environment._p.addUserDebugParameter("baseangularvelocity", -dv, dv, 0)
        ...
        actionIds = [leftwheelVelocitySlider, rightwheelVelocitySlider, joint_1_Slider, joint_2_Slider, joint_3_Slider,
                     joint_4_Slider, joint_5_Slider, joint_6_Slider, joint_7_Slider]
